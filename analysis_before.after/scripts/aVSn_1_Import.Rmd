...
```{r}
dir_in <- "analysis_before.after/raw_data"
dir_out <- "analysis_before.after/derived_data/"
...
ID <- do.call(rbind, strsplit(stud_name, "-"))[, 1:4]
ID <- paste(ID[ ,1], ID[ ,2], sep = "-")
split_name <- do.call(rbind, strsplit(stud_name, "-"))[, 1:4]

# split the ID in the separate information 
data_final <- data.frame(ID, split_name[ , 3:4], data_keep[-3],
              stringsAsFactors = FALSE)
colnames(data_final)[1:6] <- c("Sample", "Spot","Cycle", "Analysis.date",    
                             "Analysis.time", "Acquisition.date.time")

# order the the column cycle so that 'before' comes before '2000'
data_final[["Cycle"]] <- factor(data_final[["Cycle"]], levels=c("before","2000"))
...
data_final[grep("LYDIT4-4", data_final[["Sample"]]), "Contact.material"] <- "pig skin"
data_final[grep("LYDIT4-6", data_final[["Sample"]]), "Contact.material"] <- "pig skin"
data_final[grep("LYDIT4-2", data_final[["Sample"]]), "Contact.material"] <- "bone plate"
data_final[grep("LYDIT4-3", data_final[["Sample"]]), "Contact.material"] <- "bone plate"
data_final[grep("LYDIT4-8", data_final[["Sample"]]), "Contact.material"] <- "bone plate"
data_final[grep("LYDIT4-5", data_final[["Sample"]]), "Contact.material"] <- "cow scapula"
data_final[grep("LYDIT4-7", data_final[["Sample"]]), "Contact.material"] <- "cow scapula"
data_final[grep("LYDIT4-12", data_final[["Sample"]]), "Contact.material"] <- "cow scapula"
data_final[grep("LYDIT4-9", data_final[["Sample"]]), "Contact.material"] <- "skin pad"
data_final[grep("LYDIT4-10", data_final[["Sample"]]), "Contact.material"] <- "skin pad"
data_final[grep("LYDIT4-11", data_final[["Sample"]]), "Contact.material"] <- "skin pad"
data_final[grep("FLT4-4", data_final[["Sample"]]), "Contact.material"] <- "pig skin"
data_final[grep("FLT4-8", data_final[["Sample"]]), "Contact.material"] <- "pig skin"
data_final[grep("FLT4-9", data_final[["Sample"]]), "Contact.material"] <- "pig skin"
...
data_final[grep("FLT4-10", data_final[["Sample"]]), "Contact.material"] <- "bone plate"
data_final[grep("FLT4-6", data_final[["Sample"]]), "Contact.material"] <- "cow scapula"
data_final[grep("FLT4-14", data_final[["Sample"]]), "Contact.material"] <- "cow scapula"
data_final[grep("FLT4-15", data_final[["Sample"]]), "Contact.material"] <- "cow scapula"
data_final[grep("FLT4-11", data_final[["Sample"]]), "Contact.material"] <- "skin pad"
data_final[grep("FLT4-12", data_final[["Sample"]]), "Contact.material"] <- "skin pad"
data_final[grep("FLT4-13", data_final[["Sample"]]), "Contact.material"] <- "skin pad"

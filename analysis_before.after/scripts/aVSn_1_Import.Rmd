...
data_final[grep("LYDIT4-1|LYDIT4-4|LYDIT4-6", data_final[["Sample"]]), "Contact.material"] <- "pig skin"
data_final[grep("LYDIT4-2|LYDIT4-3|LYDIT4-8", data_final[["Sample"]]), "Contact.material"]  <- "bone plate"
data_final[grep("LYDIT4-5|LYDIT4-7|LYDIT4-12", data_final[["Sample"]]), "Contact.material"] <- "cow scapula"
data_final[grep("LYDIT4-9|LYDIT4-10|LYDIT4-11", data_final[["Sample"]]), "Contact.material"] <- "skin pad"
data_final[grep("FLT4-4|FLT4-8|FLT4-9", data_final[["Sample"]]), "Contact.material"] <- "pig skin"
data_final[grep("FLT4-5|FLT4-7|FLT4-10", data_final[["Sample"]]), "Contact.material"] <- "bone plate"
data_final[grep("FLT4-6|FLT4-14|FLT4-15", data_final[["Sample"]]), "Contact.material"] <- "cow scapula"
data_final[grep("FLT4-11|FLT4-12|FLT4-13", data_final[["Sample"]]), "Contact.material"] <- "skin pad"
